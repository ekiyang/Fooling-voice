...
if __name__ == "__main__":
    ...
    for wav_file in os.listdir(wav_dir):
        ...
        mcep_path = os.path.join(mcep_dir, wav_file.replace(".raw", ".mcep"))
        ...
        command = "x2x +sf < %s | frame -l 400 -p 80 | window -l 400 -L 512 | mcep -l 512 -m %d -a %f | x2x +fa%d > %s" % (wav_path, m, a, m+1, mcep_path)
        os.system(command)